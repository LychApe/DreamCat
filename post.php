...
<div class="mdui-toolbar">
    ...
    <div class="mdui-toolbar-spacer"></div>
        ...
        <div class="mdui-container">
    		...
    		<h4 class="subtitle" style="color: #ffffffe3;">时间: <time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php $this->date(); ?></time></h4>
        </div>
</div>
</div>
...
<div class="mdui-container">
    <div class="mdui-card DreamCat-card-1" style="margin-top: -6.5%;">
            ...
            <div class="mdui-row-xs-2">
              <div class="mdui-col">
                <div class="Dreamcat-post-btn">
                    <button mdui-menu="{target: '#Dreamcat-post-btn',align: 'center'}" mdui-tooltip="{content: '赞赏'}" class="mdui-btn mdui-btn-icon mdui-color-grey-200 mdui-ripple">
              ...
              <div class="mdui-col">
                <div class="Dreamcat-post-btn">
                    <button mdui-menu="{target: '#DreamCat-post-share',align: 'center'}" mdui-tooltip="{content: '分享'}" class="mdui-btn mdui-btn-icon mdui-color-grey-200 mdui-ripple">
                    <i class="mdui-icon material-icons">&#xe80d;</i>
                    </button>
                    <ul class="mdui-menu"  id="DreamCat-post-share" style="box-shadow: rgb(245 245 245 / 65%) 6px 15px 20px 18px; transform-origin: 50% 0px; position: absolute; top: 9843px; left: 481px; border-radius: 0.75rem;">
                        <li class="mdui-menu-item">
                        <a href="https://connect.qq.com/widget/shareqq/index.html?site=<?php $this->options->title(); ?>&title=<?php $this->title() ?>&summary=<?php $this->summary(); ?>&url=<?php $this->permalink() ?>" class="mdui-ripple">分享到 QQ</a>
                        </li>
                        <li class="mdui-menu-item">
                        <a href="https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=<?php $this->permalink() ?>&title=<?php $this->title() ?>&content=utf-8" class="mdui-ripple">分享到 QQ空间</a>
                        </li>
                        <li class="mdui-menu-item">
                        <a href="https://service.weibo.com/share/share.php?appkey=&title=<?php $this->title() ?>&url=<?php $this->permalink() ?>" class="mdui-ripple">分享到 微博</a>
                        </li>
                    </ul>
                </div>
              </div>
        ...
        <div class="mdui-card Dreamcat-post-copyright mdui-color-grey-50">
            <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="128" height="128"><path d="M512 106.7a405.3 405.3 0 110 810.6 405.3 405.3 0 010-810.6zm0 85.3a320 320 0 100 640 320 320 0 000-640zm42.7 277.3V704h-85.4V469.3h85.4zM512 298.7a47 47 0 110 93.8 47 47 0 010-93.8z"></path></svg>
            <div class="mdui-card-actions mdui-typo">
            #本文链接：<a href="<?php $this->permalink() ?>"><?php $this->permalink() ?></a><br>
            #本文采用 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh" target="_blank" rel="noopener">CC BY-NC-SA 4.0</a> 协议进行许可
            <br/>
