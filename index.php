...
<div
	class="mdui-container-fluid Dreamcat-appimgbar"
	style="<?php
        #导航栏高度
	...
	<div class="mdui-appbar mdui-shadow-0">
		<div class="mdui-toolbar">
			...
			<button
				...
				class="mdui-btn mdui-btn-icon mdui-hidden-md-up"
			>
...
<div
	class="mdui-container mdui-hidden-sm-down"
			...
			<div class="mdui-row">
				<div class="mdui-col-xs-6 mdui-col-sm-3">
					<form
						method="post"
						action=""
						class="Dreamcat-search-bar mdui-hidden-sm-down mdui-float-left"
					>
				...
				<div class="mdui-col-xs-6 mdui-col-sm-6">
					<form
						method="get"
						class="Dreamcat-search-bar mdui-hidden-sm-down"
						style="max-width: 100%"
					>
				...
				<div class="mdui-col-xs-6 mdui-col-sm-3">
					<form
						method="get"
						class="Dreamcat-search-bar mdui-hidden-sm-down mdui-float-right"
					>
						<button type="submit" class="submit mdui-btn mdui-btn-icon">
							<i class="mdui-icon material-icons mdui-text-color-theme-icon"
								>access_time</i
		...
		<div class="mdui-row">
			<div class="mdui-col-xs-6 mdui-col-sm-3 mdui-hidden-sm-down">
				<div class="mdui-card DreamCat-card-1" style="margin-right: 30px">
					<img
						src="<?php $this->options->DC_HeadImageUrl(); ?>"
						class="card-img-top"
						style="width: 100%"
						alt="..."
					/>
					<div class="mdui-card-primary">
						...
						<div class="mdui-card-primary-subtitle">
							<?php $this->options->DC_ProfileCardIntroduction() ?>
						</div>
					</div>
					...
					<div class="mdui-card-content">
						...
						<a
							href="<?php $this->options->DC_A_github() ?>"
						...
						<a
							href="<?php $this->options->DC_A_bilibili() ?>"
							style="text-decoration: none; color: black"
						>
						...
						<a
							href="<?php $this->options->DC_A_linkedin() ?>"
							style="text-decoration: none; color: black"
						>
						...
						<a
							href="<?php $this->options->DC_A_telegram() ?>"
							style="text-decoration: none; color: black"
						>
...
$User_ImageUrl_TF = $this->fields->User_ImageUrl_TF; if ($t[0] == 0): ?>
								<img
									class="DreamCat-card-post-wzimg DreamCat-card-post-wzimg-ts"
									src="<?php 
