		...
		<div class="lis">
			...
			<div class="ke">
				...
				<div class="item pink">
					...
					<h2 class="title"><span class="tag">#</span> <a href="" target="_blank"><?php echo($posts_A["title"]) ?></a></h2>
					<div class="des"><div class="mdui-card-primary-subtitle"><?php echo($posts_A["text"]);?></div></div>
				</div>
			</div>
		</div>
	<?php endif?>
