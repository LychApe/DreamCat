...
<head>
    ...
    <?php if (Helper::options()->CustomCdn === 'FuseAccelerationMode'): ?>
        <link rel="dns-prefetch" href="//gh.sourcegcdn.com"/>
        <link rel="dns-prefetch" href="//cdnjs.sourcegcdn.com"/>
    <?php endif; ?>
    ...
    <link rel="stylesheet preload" href="<?php CustomCDN_FAM('css/', '', 'css/mdui.min.css', 'mdui.min.css'); ?>"
          as="style">
    <link rel="stylesheet preload" href="<?php CustomCDN_FAM('css/', '', 'css/style.css', 'style.css'); ?>"
          as="style">
    ...
    <script rel="preload"
            ...
            is="script"></script>
    <script rel="preload"
            src="<?php CustomCDN_FAM('js/', '', 'js/smooth-scroll.min.js', 'smooth-scroll.min.js'); ?>"
            is="script"></script>
    <script rel="preload"
            src="<?php CustomCDN_FAM('js/', '', 'js/alifont_2359325_loysvemas8m.js', 'alifont_2359325_loysvemas8m.js'); ?>"
            is="script"></script>
    <script
        src="<?php CustomCDN_FAM('js/', '', 'js/preloadjs.min.js', 'preloadjs.min.js'); ?>"
    ></script>

    <!--[if IE]>
    <script
        src="<?php CustomCDN_FAM('js/', '', 'js/html5.min.js', 'html5.min.js'); ?>"
    ></script><![endif]-->
    <style>
        @font-face {
