...
<div class="mdui-dialog" id="About_DreamCat">
    ...
    <div class="mdui-dialog-content" style="height: 219px;">
        <blockquote>
            <div class="mdui-typo"><p>主题名称：<a href="https://typecho.me/1516.html" target="_blank">DreamCat</a> | 版本：<a href="https://github.com/LychApe/DreamCat" target="_blank">X2.0-20210711</a></p>
                <p>主题开发：<a
...
<script>
 ...
 <div class="mdui-dialog" id="weibo">
  <div class="mdui-dialog-title">加我的微博</div>
  <div class="mdui-dialog-content mdui-typo"><img src="<?php $this->options->weibo() ?>"></div>
  <div class="mdui-dialog-actions">
<button class="mdui-btn mdui-ripple" mdui-dialog-confirm>确认</button>
  </div>
</div>
 <div class="mdui-dialog" id="zfb">
  <div class="mdui-dialog-title">加我的支付宝</div>
  <div class="mdui-dialog-content mdui-typo"><img src="<?php $this->options->zfb() ?>"></div>
  <div class="mdui-dialog-actions">
<button class="mdui-btn mdui-ripple" mdui-dialog-confirm>确认</button>
  </div>
</div>
 <div class="mdui-dialog" id="weixin">
  <div class="mdui-dialog-title">加我的微信</div>
  <div class="mdui-dialog-content mdui-typo"><img src="<?php $this->options->weixin() ?>"></div>
  <div class="mdui-dialog-actions">
<button class="mdui-btn mdui-ripple" mdui-dialog-confirm>确认</button>
  </div>
</div>
